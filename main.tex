...
\section{Argumentos do verbo}\label{sec:argumentosdoverbo}
	...
	\subsection {Declarou o réu \emph{culpado}: predicativo do objeto subordinado ao verbo}\label{sec:declarouoreuculpado}
		...
		Quando o predicativo do objeto é dependente do verbo, e não do objeto, estamos diante de um caso de argumento do verbo que deve ter deprel \emph{xcomp}, como na \fullref{dep:declarouoreuculpado} e na \fullref{dep:euoconsideroidiota}.

		Na frase \fullref{dep:xcomp4}, além do \emph{xcomp} objeto oracional, há também o \emph{xcomp} que é predicativo do objeto \say{currículo}, pois é argumento do verbo \emph{deixar}.

		Caso o predicativo seja dependente do objeto, será \emph{acl}, conforme \fullref{sec:predicativos}.
