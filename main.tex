...
\section{Conjunções}
	...
	\subsection{Conjunções subordinativas}
		...
		\begin{figure*}[htbp]
					...
					\begin{dependency}
						\begin{deptext}
							SCONJ \& PRON \& VERB \& DET \& NOUN \& PUNCT \& VERB \& NOUN \& ADJ \& CCONJ \& VERB \& 						DET \& NOUN \& ADJ \\
					...
					\end{dependency}
					\caption{\emph{Se} eu dirigisse uma federação, apresentaria balanços mensais e liberaria minhas contas bancárias}\label{dep:sconj1}
				\end{figure*}
		...
		\begin{figure*}[htbp]
					...
					\begin{dependency}
						\begin{deptext}
							CCONJ \& PUNCT \& SCONJ \& SCONJ \& VERB \& ADV \& VERB \& VERB \& PRON \& ADJ  \\
						...
						\deproot{7}{root}				
					\end{dependency}
					\caption{Mas, \emph{mesmo que} quisessem não conseguiriam fazer nada menor}\label{dep:sconj2}
				\end{figure*}
	
	
	\subsection{Advérbios interrogativos}\label{sec:adverbiosinterrogativos}
	
		Advérbios são palavras que costumam modificar verbos, adjetivos e outros advérbios. Além disso, em português, algumas dessas palvras podem operar como conjunções subordinativas quando aparecem na introdução de orações subordinadas adverbiais.
		...
		\begin{figure*}[htbp]
					...
					\begin{dependency}
						\begin{deptext}
								SCONJ \& VERB \& DET \& NOUN \& PUNCT \& AUX \& SCONJ \& VERB \&										 VERB \& DET \& NOUN \\
								Quando \& recebo \& a \& bola \& , \& tenho \& que \& 													ficar \& olhando \& sua \& trajetória \\
						\end{deptext}
						\depedge{2}{1}{mark}
						\depedge{8}{2}{advcl}	
					\end{dependency}
					\caption{\emph{Quando} recebo a bola, tenho que ficar olhando sua trajetória}
				\end{figure*}
