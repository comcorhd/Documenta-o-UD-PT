...
\section{Adjuntos e argumentos do substantivo}\label{sec:adjuntoseargumentosdosubstantivo}
	...
	\subsection{Aposto}\label{sec:aposto}
		...
		Também estão em relação de aposto endereços de internet e e-mails, como em \fullref{dep:email}, quando há a presença dos dois pontos. Caso não haja pontuação, a classificação será de \emph{nmod}. (Ver \fullref{sec:nomeseguidodenome}
	...
	\section{O que fazer com...}\label{sec:quefazer}
		...
		\subsection{Nome seguido de nome: \emph{appos}, \emph{compound}, \emph{flat:name} ou \emph{nmod/amod}?}\label{sec:nomeseguidodenome}
			...
			\subsubsection{\emph{appos}}\label{sec:nomeappos}
				...
				Utilizado quando o segundo nome especifica um tipo do primeiro nome. Ver também: \fullref{sec:aposto}
			...
			\subsubsection{\emph{compound}}\label{sec:nomecompound}
				...
				poli(bisfenol \emph{A-co-epicloridrina})

				1,2 milhão de barris \emph{/ dia}
