...
\section{Formas participiais: verbo, adjetivo ou outra coisa?}\label{sec:formaspart}
	...
	A discussão sobre o status das formas participiais, frequentemente ambíguas entre \emph{ADJ} ou \emph{VERB}, é reconhecida na literatura linguística, e não é um fenômeno específico do Português (ver, por exemplo, \cite{10.1007/978-3-319-99722-3_46} e \cite{de2016classes}).
...
\section{Numerais}\label{sec:numerais}
	...
	\subsection{Números compostos}\label{sec:numeroscompostos}
		...
		Quando há um sintagma preposicionado (\fullref{montantede}), a relação se inverte: o primeiro número do número composto será o head (\say{1300}), e o substantivo (\say{dólares}), \emph{nmod} do número.
