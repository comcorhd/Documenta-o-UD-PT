...
\section{Adjuntos e argumentos do substantivo}\label{sec:adjuntoseargumentosdosubstantivo}
	...
	\subsection{Adjunto adnominal}\label{sec:adjuntoadnominal}
		...
		\subsubsection{Orações relativas}\label{sec:relativas}
			...
			Adjuntos adnominais na forma de orações (adjetivas/relativas) devem ter deprel \emph{acl:relcl} (que vem de adjective clause: relative clause), caso sejam desenvolvidas (\fullref{dep:aclrelcl}), ou \emph{acl}, caso sejam reduzidas (\fullref{dep:acl}).
