...
\section{Argumentos do verbo}\label{sec:argumentosdoverbo}
	...
	\subsection{Caso seja nominal}\label{sec:objetonominal}
		...
		\begin{figure*}[htbp]
			...
			\begin{dependency}
				\begin{deptext}
					DET \& NOUN \& VERB \& ADV \& DET \& NOUN \& ADP \& NOUN \& ADP \& DET \& NOUN \\
		...
		\begin{figure*}[htbp]
			...
			\begin{dependency}
				...
				\depedge{9}{8}{mark}
			\end{dependency}
			\caption{Souza negou aos réus o direito de apelarem}\label{dep:iobjprototipico}
		\end{figure*}
		...
		\begin{figure*}[htbp]
			...
			\begin{dependency}
				\begin{deptext}
					...
					o \& eleitor \& quer \& o \& PT \& participar \& de \& o \& govero \\
				\end{deptext}
				\deproot{3}{root}
				\depedge{3}{2}{nsubj}
				\depedge{3}{5}{obj}
				...
				\depedge{9}{4}{det}
			\end{dependency}
			\caption{Os eleitores querem o PT participando do governo}\label{dep:ccomp2}
		\end{figure*}
