...
\section{Adjuntos e argumentos do substantivo}\label{sec:adjuntoseargumentosdosubstantivo}
	...
	\subsection{Aposto}\label{sec:aposto}
		...
		Também estão em relação de aposto endereços de internet e emails, como em \fullref{dep:sitenet} e \fullref{dep:email}, respectivamente.
		...
		\subsubsection{Aposto e traduções}\label{sec:apostotrad}
			...
			As diretivas originais UD não especificam como anotar termos/expressões frases que são traduções. Em UD-PT, optamos por deixá-las como aposto: \fullref{dep:apostotrad}

			\begin{figure}
			    	\centering
			    	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{imagesDrive/appos1.PNG}
			    	\caption{SOFC (solid oxide fuel cell – célula a combustível de óxido sólido):}
