...
\section{Numerais}\label{sec:numerais}
	...
	\subsection{\emph{um}: numeral, pronome ou artigo?}\label{sec:numeralpronomeouartigo}
		...
		Em português, a palavra \say{um} pode ser classificada de muitas maneiras. Tendo em vista sua ambiguidade, definimos situações em que a sua leitura preferencial será numeral, artigo ou pronome.
		...
		\say{um} será artigo indeterminado em todos os casos em que estiver modificando um nome e a leitura de indeterminação for possível. É o caso de \fullref{dep:umartigo1} e \fullref{dep:umartigo2}.

		\say{um} será pronome indeterminado em todos os casos em que estiver substituindo um nome. É o caso de \fullref{dep:umpronome1} e \fullref{dep:umpronome2}.
...
\chapter{Frases difíceis, retiradas do Bosque-UD}
\hyperlink{toc}{Ir para tabela de conteúdos\\}
