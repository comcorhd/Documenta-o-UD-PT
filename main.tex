...
\hyperlink{toc}{Ir para tabela de conteúdos\\}
	...
	\section{O que fazer com...}\label{sec:quefazer}
		...
		\subsection{Nome seguido de nome: \emph{appos}, \emph{compound}, \emph{flat:name} ou \emph{nmod/amod}?}\label{sec:nomeseguidodenome}
			...
			\textbf{\emph{appos}}: quando o segundo nome especifica um tipo do primeiro nome
			...
			Lei \emph{nº 997} (os algarismos são \emph{appos} de \say{nº})
			...
			\textbf{\emph{compound}}: quando a expressão inteira é um termo relevante para algum domínio; expressão cristalizada
			...
			\textbf{\emph{flat:name}}: nome de empresa/pessoa; sem sintaxe interna
			...
			\textbf{\emph{nmod} e \emph{amod}}: quando não se aplicam os casos anteriores; no caso de substantivo (\emph{nmod}), há a preposição \say{de} ou ela está omitida
