...
\section{Adjuntos e argumentos do substantivo}
	...
	\subsection{Aposto}\label{sec:aposto}
		...
		\subsubsection{Orações com \emph{, o que}}\label{sec:apostooque}
		...
		\subsubsection{Apostos coordenados}\label{sec:apostoscoordenados}
			...
			Apostos coordenados são analisados como apostos dependentes da primeira palavra, e não como coordenações.
			...
			\begin{figure*}[htbp]
				...
				\begin{dependency}
					\begin{deptext}
						DET \& NOUN \& ADJ \& PUNCT \& PROPN \& PUNCT \& PROPN \& CCONJ \& PROPN \\
						Os \& continentes \& obstinados \& , \& África \& , \& Ásia \& e \& Europa \\
						o \& continente \& obstinado \& , \& África \& , \& Ásia \& e \& Europa \\ 
					\end{deptext}
					\deproot{2}{root}
					\depedge{2}{1}{det}
					\depedge{2}{3}{amod}
					...
					\depedge{2}{9}{appos}
				\end{dependency}
				\caption{Os continentes obstinados, \emph{África}, \emph{Ásia} e \emph{Europa}}\label{dep:apostoscoordenados}
			\end{figure*}
